...
evaluate = mz.callbacks.EvaluateAllMetrics(model, x=valid_x, y=valid_y)

history = model.fit_generator(train_generator, epochs=2, callbacks=[evaluate], workers=5, use_multiprocessing=False)
